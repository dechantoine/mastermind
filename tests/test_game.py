...
class TestMasterMind(unittest.TestCase):
    ...
    def test_check_code(self):
        ...
        # Test correct guess
        guess = [1, 2, 3, 4]
        right_positions, wrong_positions = game.check_code(guess)
    ...
    def test_play_turn(self):
        ...
        # Test correct guess
        guess = [1, 2, 3, 4]
        rounds = game._play_turn(guess)
        self.assertEqual(rounds[0]['guess'], guess)
        self.assertEqual(rounds[0]['right_positions'], 4)
        ...
        guess = [5, 5, 5, 5]
        rounds = game._play_turn(guess)
        self.assertEqual(rounds[3]['guess'], guess)
        self.assertEqual(rounds[3]['right_positions'], 0)
        self.assertEqual(rounds[3]['wrong_positions'], 0)
